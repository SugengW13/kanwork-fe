...
<template>
  <div
    ...
    :class="{
      'backdrop-blur-sm bg-black/25': isOpen,
      'opacity-0 pointer-events-none': !isOpen,
    }"
    @click.self="isOpen = false"
  >
    <div
      class="absolute bg-white top-0 bottom-0 w-100 border-r border-accented space-y-4 flex flex-col px-5 py-10 transition-transform duration-300"
    ...
    >
      <nuxt-link to="#">
        <div class="hover:bg-primary/5 rounded-lg px-5 py-3 space-x-2 transition flex items-center">
          ...
          <p class="text-lg font-medium">Reporting</p>
        </div>
      </nuxt-link>
